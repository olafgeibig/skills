...
1. Put generic TurboVault tool mechanics and troubleshooting in this skill.
2. Put generic vault structure, note, MoC, and navigation rules in `vault-ops`.
3. Put wiki-specific ingest, query, source, and lint behavior in `vault-wiki`.
4. Put reusable project-specific procedure in the appropriate `project-*` skill.
5. Put project facts in project content and profile/environment quirks in profile guidance.
